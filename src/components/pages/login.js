                        ...
                        <form>
                            <div className="col-md pt-1">
                                ...
                                <div className="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-0" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" maxLength={10} required/>
                                </div>
                            </div>
                            <div className="col-md pt-2">
                                ...
                                <input type="password" className="form-control rounded-0" id="inputPassword" maxLength={25} required/>
